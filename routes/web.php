...
Route::middleware(["CheckLogin"])->prefix("/epos/")->group(function (){
    ...
    Route::get('/table', [\App\Http\Controllers\EposController::class,"table"])->name("epos_table");//我的-详细
    ...
    Route::post('/get_income_info', [\App\Http\Controllers\EposController::class,"get_income_info"]);//获取账单所需信息
    ...
    Route::post('/get_finish_view', [\App\Http\Controllers\EposController::class,"get_finish_view"]);//获取结单信息
    Route::post('/get_desk_bill', [\App\Http\Controllers\EposController::class,"get_desk_bill"]);//获取当前桌账单信息
    Route::post('/get_today_income', [\App\Http\Controllers\EposController::class,"get_today_income"]);//获取当日流水信息
    Route::post('/get_all_income', [\App\Http\Controllers\EposController::class,"get_all_income"]);//获取全部流水信息
    Route::post('/get_today_dish', [\App\Http\Controllers\EposController::class,"get_today_dish"]);//获取当日菜品成本信息
    Route::post('/get_all_dish', [\App\Http\Controllers\EposController::class,"get_all_dish"]);//获取全部菜品成本信息
    Route::post('/get_all_item', [\App\Http\Controllers\EposController::class,"get_all_item"]);//获取全部进货信息
    ...
    Route::post('/delete_bill_dish', [\App\Http\Controllers\EposController::class,"delete_bill_dish"]);//删除已点菜品
