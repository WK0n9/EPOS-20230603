...
<div>
    ...
    <div id="Desk_ID" style="height: calc(100vh - 120px);width: 100%;overflow-y: auto">
        <div onclick="window.location.href = '{{ URL::to('/epos/table?info=1') }}'">
            <div class="row">
                <div class="col-8 row_line" style="">当日流水(应收)</div>
                <div id="today-income" class="col-4 row_line" style=""></div>
            </div>
            <div class="row">
                <div class="col-8 row_line" style="">当日流水(实收)</div>
                <div id="today-income-real" class="col-4 row_line" style=""></div>
            </div>
        </div>
        <div style="height: 30px;width: 100%"></div>
        <div onclick="window.location.href = '{{ URL::to('/epos/table?info=2') }}'">
            <div class="row">
                <div class="col-8 row_line" style="">当日成本</div>
                <div id="today-cost" class="col-4 row_line" style=""></div>
            </div>
            <div class="row">
                <div class="col-8 row_line" style="">当日净收入</div>
        ...
        {{--            </div>--}}
        {{--            <div style="height: 30px;width: 100%"></div>--}}
        <div onclick="window.location.href = '{{ URL::to('/epos/table?info=3') }}'">
            <div class="row">
        ...
        <div style="height: 30px;width: 100%"></div>
        <div onclick="window.location.href = '{{ URL::to('/epos/table?info=4') }}'">
            <div class="row">
        ...
        <div style="height: 30px;width: 100%"></div>
        <div onclick="window.location.href = '{{ URL::to('/epos/table?info=5') }}'">
            <div class="row">
...
<script>
    ...
    setTimeout(calcIncome, 500);
    setTimeout(calcCost, 1000);
    setTimeout(calcItem, 1500);
    setTimeout(calcProfit, 2000);
</script>
</body>
</html>
